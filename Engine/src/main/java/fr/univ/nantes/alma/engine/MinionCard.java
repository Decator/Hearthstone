...
public class MinionCard extends AbstractCard {
	...
	MinionCard(int idMinion, String type, String name, int manaCost, int damage, String description, int healthPoints, boolean taunt, boolean lifesteal, boolean charge, int attackBuffAura) {
	...
	public String toString() {
		return "Minion [healthPoints=" + healthPoints + ", taunt=" + taunt + ", lifesteal=" + lifesteal + ", charge="
