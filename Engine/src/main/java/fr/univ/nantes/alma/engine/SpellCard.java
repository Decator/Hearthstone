...
public class SpellCard extends AbstractCard {
     ...
     */
    SpellCard(int idSpell, String type, String name, int manaCost, int damage, String description, int nbSummon, int idInvocation, int attackBuff, int armorBuff, int nbDraw, boolean polymorph, String target) {
	...
	public String toString() {
		return "Spell [nbSummon=" + nbSummon + ", idInvocation=" + idInvocation + ", attackBuff=" + attackBuff
