...
public class TestHeroCardRepository {
	...
	public void testFindAll() {
		HeroCard hero1 = new HeroCard(1, "mage", "Jaina", 1, 0, 0, 0, "Boule de feu : Inflige 1 point de dégâts.", "all_1_all");
		HeroCard hero2 = new HeroCard(2, "paladin", "Uther", 0, 1, 12, 0, "Renfort : Invoque une recrue de la Main d'argent 1/1.", null);
		HeroCard hero3 = new HeroCard(3, "warrior", "Garrosh", 0, 0, 0, 2, "Gain d'armure ! : Confère 2 points d'armure.", null);
